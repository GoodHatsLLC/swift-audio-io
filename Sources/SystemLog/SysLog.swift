            ...
            HStack {
              Button {
                ...
                Label(
                  ...
                  systemImage: selectedCategories.count == categories.count ? "checkmark.circle.fill" : "circle"
                )
              }
            ...
            HStack {
              Button {
                ...
                Label(
                  ...
                  systemImage: selectedLevels.count == levels.count ? "checkmark.circle.fill" : "circle"
                )
              }
              .buttonStyle(.bordered)
...
extension View {
  ...
  /// ```
    @ViewBuilder
    public func systemLogViewerToolbarItem(placement: ToolbarItemPlacement = .automatic, enabled: Bool) -> some View {
    self.toolbar {
        if enabled {
